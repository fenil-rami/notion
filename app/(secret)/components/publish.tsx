...
export const Publish = ({ document }: PublishProps) => {
  ...
  return (
    <Popover>
      ...
      <Button size={"sm"} variant={"ghost"} onClick={() => { router.push(`/documents/${document._id}/tasks`) }}>
          Tasks
        </Button>
        <Button size={"sm"} variant={"ghost"} onClick={() => { router.push(`/documents/${document._id}/users`) }}>
          Users
        </Button>
